...
public class Chatbot extends JFrame implements KeyListener {
    ...
    public void BotReplies()
    {
        ...
        textField.setText("");
        if(text.contains("hi")||text.contains("مرحبا")||text.contains("hallo")||text.contains("hello"))
            textArea.append("chatBot--> "+text+", how you are you?"+"\n");
        else if(text.contains("how are you")||text.contains("what about you")||text.contains("i'm fine"))
